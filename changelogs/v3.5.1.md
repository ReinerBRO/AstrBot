...
1. 适配 `gemini-2.0-flash-exp-image-generation` 对图片模态的输入 [#1017](https://github.com/PersbotDevs/Persbot/issues/1017)
2. 在 MessageChain 类中添加 at 和 at_all 方法，用于快速添加 At 消息 @left666
3. Gewechat Client 增加获取通讯录列表接口
4. 支持 /llm 指令快捷启停 LLM 功能 [#296](https://github.com/PersbotDevs/Persbot/issues/296)

## 🎈 功能性优化

1. Edge TTS 支持使用代理
2. 在 Lifecycle 新增插件资源清理逻辑 @Raven95676
3. Docker 镜像提供内置 FFmpeg [#979](https://github.com/PersbotDevs/Persbot/issues/979)
