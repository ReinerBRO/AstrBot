...
**新增：**
- 对部分需要 Webhook 的适配器（QQ 官方机器人、Slack、企业微信、微信客服、企业微信智能机器人、微信公众号）支持统一的 Webhook 链接模式，避免开多个端口。并支持在 WebUI 机器人卡片中查看和复制 Webhook 链接。详情请看：[统一 Webhook 模式](https://docs.persbot.app/use/unified-webhook.html)
- 新增 Kubernetes 部署文档。
