...
1. 新增：支持 MCP 的 Streamable HTTP 传输方式。详见 [#1637](https://github.com/PersbotDevs/Persbot/issues/1637)
2. 新增：支持 MCP 的 SSE 传输方式的自定义请求头。详见 [#1659](https://github.com/PersbotDevs/Persbot/issues/1659)
...
14. 优化：在使用 /llm 指令关闭后重启 Persbot 后，模型提供商未被加载
