        ...
        <v-tabs-window v-model="tab" class="config-tabs-window" :style="readonly ? 'pointer-events: none; opacity: 0.6;' : ''">
            ...
            <div style="margin-left: 16px; padding-bottom: 16px">
                <small>{{ tm('help.helpPrefix') }}
                    <a href="https://persbot.app/" target="_blank">{{ tm('help.documentation') }}</a>
                    {{ tm('help.helpMiddle') }}
...
<script>
import PersbotConfigV4 from '@/components/shared/PersbotConfigV4.vue';
import { useModuleI18n } from '@/i18n/composables';

export default {
  name: 'PersbotCoreConfigWrapper',
  components: {
    PersbotConfigV4
  },
  props: {
