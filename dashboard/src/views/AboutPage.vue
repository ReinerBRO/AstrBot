        ...
        <div style="flex-grow: 1; display: flex; align-items: center; justify-content: center; flex-direction: column;">
            <div style="text-align: center; max-width: 600px;">
                ...
                <div style="margin-top: 20px; display: flex; justify-content: center;">
                    <v-btn @click="open('https://github.com/PersbotDevs/Persbot')" color="primary" variant="tonal" size="small"
                        prepend-icon="mdi-star">
                        {{ tm('hero.starButton') }}
                    </v-btn>
                    <v-btn class="ml-4" @click="open('https://github.com/PersbotDevs/Persbot/issues')" color="secondary" size="small"
