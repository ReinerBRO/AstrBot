...
from persbot.core.pipeline.bootstrap import ensure_builtin_stages_registered
from persbot.core.pipeline.process_stage.method.agent_sub_stages.internal import (
    InternalAgentSubStage,
)
from persbot.core.pipeline.process_stage.method.agent_sub_stages.third_party import (
    ThirdPartyAgentSubStage,
)
from persbot.core.pipeline.stage import Stage, registered_stages
from persbot.core.pipeline.stage_order import STAGES_ORDER
...
def test_smoke_critical_imports_in_fresh_interpreter() -> None:
    code = (
        "import importlib;"
        "mods=["
        "'persbot.core.core_lifecycle',"
        "'persbot.core.astr_main_agent',"
        "'persbot.core.pipeline.scheduler',"
        "'persbot.core.pipeline.process_stage.method.agent_sub_stages.internal',"
        "'persbot.core.pipeline.process_stage.method.agent_sub_stages.third_party'"
        "];"
...
def test_pipeline_package_exports_remain_compatible() -> None:
    import persbot.core.pipeline as pipeline
