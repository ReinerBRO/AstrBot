"""Tests for PersbotMessage and MessageMember classes."""

import time
from unittest.mock import patch

from persbot.core.message.components import Image, Plain
from persbot.core.platform.persbot_message import PersbotMessage, Group, MessageMember
...
class TestPersbotMessage:
    """Tests for PersbotMessage class."""

    def test_persbot_message_creation(self):
        """Test creating an PersbotMessage."""
    ...
    def test_persbot_message_timestamp(self):
        """Test timestamp is set on creation."""
        with patch.object(time, "time", return_value=1234567890):
            message = PersbotMessage()
            assert message.timestamp == 1234567890

    def test_persbot_message_all_attributes(self):
        """Test setting all attributes on PersbotMessage."""
        message = PersbotMessage()
    ...
    def test_persbot_message_str(self):
        """Test __str__ method."""
        message = PersbotMessage()
        message.type = MessageType.FRIEND_MESSAGE
        message.self_id = "bot123"
...
class TestPersbotMessageGroupId:
    """Tests for PersbotMessage group_id property."""
...
class TestPersbotMessageTypes:
    """Tests for PersbotMessage with different message types."""

    def test_friend_message_type(self):
        """Test PersbotMessage with FRIEND_MESSAGE type."""
        message = PersbotMessage()
        message.type = MessageType.FRIEND_MESSAGE
    ...
    def test_group_message_type(self):
        """Test PersbotMessage with GROUP_MESSAGE type."""
        message = PersbotMessage()
    ...
    def test_other_message_type(self):
        """Test PersbotMessage with OTHER_MESSAGE type."""
        message = PersbotMessage()
...
class TestPersbotMessageChain:
    """Tests for PersbotMessage message chain."""
