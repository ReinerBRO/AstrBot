"""此功能已过时，参考 https://persbot.app/dev/plugin.html#%E6%B3%A8%E5%86%8C%E6%8F%92%E4%BB%B6%E9%85%8D%E7%BD%AE-beta"""
...
def load_config(namespace: str) -> dict | bool:
    ...
    """
    path = os.path.join(get_persbot_data_path(), "config", f"{namespace}.json")
...
def put_config(namespace: str, name: str, key: str, value, description: str) -> None:
    ...
    config_dir = os.path.join(get_persbot_data_path(), "config")
