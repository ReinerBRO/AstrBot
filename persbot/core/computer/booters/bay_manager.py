...
When no Bay endpoint is configured, Persbot can automatically start a Bay
...
BAY_IMAGE = "ghcr.io/persbotdevs/shipyard-neo-bay:latest"
BAY_CONTAINER_NAME = "persbot-bay"
BAY_LABEL = "persbot.bay.managed"
BAY_PORT = 8114
HEALTH_TIMEOUT_S = 60
...
class BayContainerManager:
    ...
    async def ensure_running(self) -> str:
        ...
        If a container labelled ``persbot.bay.managed`` already exists
