...
def _ensure_safe_path(path: str) -> str:
    ...
    allowed_roots = [
        os.path.abspath(get_persbot_root()),
        os.path.abspath(get_persbot_data_path()),
        os.path.abspath(get_persbot_temp_path()),
    ]
...
class LocalShellComponent(ShellComponent):
    async def exec(
        ...
        def _run() -> dict[str, Any]:
            ...
            working_dir = _ensure_safe_path(cwd) if cwd else get_persbot_root()
            if background:
