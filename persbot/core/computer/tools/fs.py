...
from persbot.api import FunctionTool, logger
...
from persbot.core.message.components import File
...
class FileDownloadTool(FunctionTool):
    name: str = "persbot_download_file"
    description: str = (
    ...
    async def call(
        ...
        try:
            ...
            local_path = os.path.join(
                get_persbot_temp_path(), f"sandbox_{uuid.uuid4().hex[:4]}_{name}"
            )
