...
from persbot.core.astr_agent_context import AstrAgentContext, AstrMessageEvent
from persbot.core.computer.computer_client import get_booter, get_local_booter
from persbot.core.computer.tools.permissions import check_admin_permission
...
class PythonTool(FunctionTool):
    name: str = "persbot_execute_ipython"
...
class LocalPythonTool(FunctionTool):
    name: str = "persbot_execute_python"
    description: str = (
