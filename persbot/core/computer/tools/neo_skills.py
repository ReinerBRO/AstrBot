...
from persbot.core.agent.tool import ToolExecResult
...
class GetExecutionHistoryTool(NeoSkillToolBase):
    name: str = "persbot_get_execution_history"
...
class AnnotateExecutionTool(NeoSkillToolBase):
    name: str = "persbot_annotate_execution"
...
class CreateSkillPayloadTool(NeoSkillToolBase):
    name: str = "persbot_create_skill_payload"
    description: str = (
...
class GetSkillPayloadTool(NeoSkillToolBase):
    name: str = "persbot_get_skill_payload"
...
class CreateSkillCandidateTool(NeoSkillToolBase):
    name: str = "persbot_create_skill_candidate"
    description: str = (
    ...
    parameters: dict = field(
        default_factory=lambda: {
            ...
            "properties": {
                ...
                "payload_ref": {
                    "type": "string",
                    "description": "Optional payload reference created by persbot_create_skill_payload.",
                },
            },
...
class ListSkillCandidatesTool(NeoSkillToolBase):
    name: str = "persbot_list_skill_candidates"
...
class EvaluateSkillCandidateTool(NeoSkillToolBase):
    name: str = "persbot_evaluate_skill_candidate"
...
class PromoteSkillCandidateTool(NeoSkillToolBase):
    name: str = "persbot_promote_skill_candidate"
    description: str = (
...
class ListSkillReleasesTool(NeoSkillToolBase):
    name: str = "persbot_list_skill_releases"
...
class RollbackSkillReleaseTool(NeoSkillToolBase):
    name: str = "persbot_rollback_skill_release"
...
class SyncSkillReleaseTool(NeoSkillToolBase):
    name: str = "persbot_sync_skill_release"
    description: str = (
