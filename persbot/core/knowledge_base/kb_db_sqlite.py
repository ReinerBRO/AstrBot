...
from persbot.core.utils.persbot_path import get_persbot_knowledge_base_path
...
class KBSQLiteDatabase:
    def __init__(self, db_path: str | None = None) -> None:
        ...
        Args:
            db_path: 数据库文件路径, 默认位于 Persbot 数据目录下的 knowledge_base/kb.db

        """
        if db_path is None:
            db_path = str(Path(get_persbot_knowledge_base_path()) / "kb.db")
