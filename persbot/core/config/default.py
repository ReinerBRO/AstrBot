...
VERSION = "4.20.1"
DB_PATH = os.path.join(get_persbot_data_path(), "data_v4.db")
...
DEFAULT_CONFIG = {
    ...
    "log_file_path": "logs/persbot.log",
    "log_file_max_mb": 20,
    "temp_dir_max_size": 1024,
    "trace_enable": False,
    "trace_log_enable": False,
    "trace_log_path": "logs/persbot.trace.log",
    "trace_log_max_mb": 20,
    "pip_install_arg": "",
            ...
            "platform": {
                ...
                "config_template": {
                    ...
                    "Telegram": {
                        ...
                        "start_message": "Hello, I'm Persbot!",
                    ...
                    "Slack": {
                        ...
                        "slack_webhook_path": "/persbot-slack-webhook/callback",
                    },
                    "Line": {
                        "id": "line",
                        "type": "line",
                ...
                "items": {
                    ...
                    "wpp_active_message_poll": {
                        ...
                        "type": "bool",
                        "hint": "只有当你发现微信消息没有按时同步到 Persbot 时，才需要启用这个功能，默认不启用。",
                    },
                    ...
                    "telegram_command_register": {
                        ...
                        "type": "bool",
                        "hint": "启用后，Persbot 将会自动注册 Telegram 命令。",
                    },
                    "telegram_command_auto_refresh": {
                        "description": "Telegram 命令自动刷新",
                        "type": "bool",
                        "hint": "启用后，Persbot 将会在运行时自动刷新 Telegram 命令。(单独设置此项无效)",
                    },
                    ...
                    "unified_webhook_mode": {
                        ...
                        "type": "bool",
                        "hint": "Webhook 模式下使用 Persbot 统一 Webhook 入口，无需单独开启端口。回调地址为 /api/platform/webhook/{webhook_uuid}。",
                    },
                    "webhook_uuid": {
                        "invisible": True,
            ...
            "platform_settings": {
                ...
                "items": {
                    ...
                    "path_mapping": {
                        "type": "list",
                        "items": {"type": "string"},
                        "hint": "此功能解决由于文件系统不一致导致路径不存在的问题。格式为 <原路径>:<映射路径>。如 `/app/.config/QQ:/var/lib/docker/volumes/xxxx/_data`。这样，当消息平台下发的事件中图片和语音路径以 `/app/.config/QQ` 开头时，开头被替换为 `/var/lib/docker/volumes/xxxx/_data`。这在 Persbot 或者平台协议端使用 Docker 部署时特别有用。",
                    },
                },
            },
            "content_safety": {
            ...
            "provider": {
                ...
                "config_template": {
                    ...
                    "Dify": {
                        ...
                        "dify_workflow_output_key": "persbot_wf_output",
                        "dify_query_input_key": "persbot_text_query",
                        "variables": {},
                        "timeout": 60,
                        "proxy": "",
                    },
                ...
                "items": {
                    ...
                    "rerank_api_base": {
                        ...
                        "type": "string",
                        "hint": "Persbot 会在请求时在末尾加上 /v1/rerank。",
                    },
                    "rerank_api_key": {
                        "description": "API Key",
                        "type": "string",
                    ...
                    "dify_workflow_output_key": {
                        ...
                        "type": "string",
                        "hint": "Dify Workflow 输出变量名。当应用类型为 workflow 时才使用。默认为 persbot_wf_output。",
                    },
                    "dify_query_input_key": {
                        "description": "Prompt 输入变量名",
                        "type": "string",
                        "hint": "发送的消息文本内容对应的输入变量名。默认为 persbot_text_query。",
                        "obvious": True,
                    },
                    "coze_api_key": {
                    ...
                    "auto_save_history": {
                        ...
                        "type": "bool",
                        "hint": "启用后，将由 Coze 进行对话历史记录管理, 此时 Persbot 本地保存的上下文不会生效(仅供浏览), 对 Persbot 的上下文进行的操作也不会生效。如果为禁用, 则使用 Persbot 管理上下文。",
                    },
                },
            },
            "provider_settings": {
    ...
    "ai_group": {
        ...
        "metadata": {
            "agent_runner": {
                ...
                "hint": "选择 AI 对话的执行器，默认为 Persbot 内置 Agent 执行器，可使用 Persbot 内的知识库、人格、工具调用功能。如果不打算接入 Dify、Coze、DeerFlow 等第三方 Agent 执行器，不需要修改此节。",
                "type": "object",
                "items": {
            ...
            "agent_computer_use": {
                ...
                "items": {
                    ...
                    "provider_settings.computer_use_require_admin": {
                        "description": "需要 Persbot 管理员权限",
                        "type": "bool",
                        "hint": "开启后，需要 Persbot 管理员权限才能调用使用电脑能力。在平台配置->管理员中可添加管理员。使用 /sid 指令查看管理员 ID。",
                    },
            ...
            "proactive_capability": {
                ...
                "hint": "https://docs.persbot.app/use/proactive-agent.html",
                "type": "object",
                "items": {
                    "provider_settings.proactive_capability.add_cron_tools": {
                        "description": "启用",
                        "type": "bool",
                        "hint": "启用后，将会传递给 Agent 相关工具来实现主动型 Agent。你可以告诉 Persbot 未来某个时间要做的事情，它将被定时触发然后执行任务。",
                    },
                },
                "condition": {
                    "provider_settings.agent_runner_type": "local",
            ...
            "general": {
                ...
                "items": {
                    ...
                    "disable_builtin_commands": {
                        "description": "禁用自带指令",
                        "type": "bool",
                        "hint": "禁用所有 Persbot 的自带指令，如 help, provider, model 等。",
                    },
                },
            },
            "whitelist": {
            ...
            "system": {
                ...
                "items": {
                    ...
                    "log_file_path": {
                        "description": "日志文件路径",
                        "type": "string",
                        "hint": "相对路径以 data 目录为基准，例如 logs/persbot.log；支持绝对路径。",
                    },
                    "log_file_max_mb": {
                    ...
                    "trace_log_path": {
                        ...
                        "type": "string",
                        "hint": "相对路径以 data 目录为基准，例如 logs/persbot.trace.log；支持绝对路径。",
                    },
                    "trace_log_max_mb": {
                    ...
                    "callback_api_base": {
                        ...
                        "type": "string",
                        "hint": "外部服务可能会通过 Persbot 生成的回调链接（如文件下载链接）访问 Persbot 后端。由于 Persbot 无法自动判断部署环境中对外可达的主机地址（host），因此需要通过此配置项显式指定 “外部服务如何访问 Persbot” 的地址。如 http://localhost:6185，https://example.com 等。",
                    },
                    "timezone": {
                        "description": "时区",
                        "type": "string",
