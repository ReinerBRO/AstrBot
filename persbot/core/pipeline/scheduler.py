...
from persbot.core.platform.sources.webchat.webchat_event import WebChatMessageEvent
from persbot.core.platform.sources.wecom_ai_bot.wecomai_event import (
