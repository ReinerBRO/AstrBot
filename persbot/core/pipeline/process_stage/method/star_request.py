"""本地 Agent 模式的 Persbot 插件调用 Stage"""
...
from persbot.core.star.star_handler import EventType, StarHandlerMetadata
...
class StarRequestSubStage(Stage):
    async def initialize(self, ctx: PipelineContext) -> None:
        self.prompt_prefix = ctx.persbot_config["provider_settings"]["prompt_prefix"]
        self.identifier = ctx.persbot_config["provider_settings"]["identifier"]
        self.ctx = ctx
