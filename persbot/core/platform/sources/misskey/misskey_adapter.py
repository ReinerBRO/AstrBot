...
from persbot.core.platform.astr_message_event import MessageSession
...
class MisskeyPlatformAdapter(Platform):
            ...
            async def _upload_comp(comp) -> object | None:
                ...
                try:
                    ...
                    if local_path and isinstance(local_path, str):
                        data_temp = get_persbot_temp_path()
    ...
    async def convert_message(self, raw_data: dict[str, Any]) -> PersbotMessage:
        """将 Misskey 贴文数据转换为 PersbotMessage 对象"""
    ...
    async def convert_chat_message(self, raw_data: dict[str, Any]) -> PersbotMessage:
        """将 Misskey 聊天消息数据转换为 PersbotMessage 对象"""
    ...
    async def convert_room_message(self, raw_data: dict[str, Any]) -> PersbotMessage:
        """将 Misskey 群聊消息数据转换为 PersbotMessage 对象"""
        sender_info = extract_sender_info(raw_data, is_chat=True)
