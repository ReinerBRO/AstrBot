...
class DiscordPlatformAdapter(Platform):
    ...
    def _convert_message_to_abm(self, data: dict) -> PersbotMessage:
        """将普通消息转换为 PersbotMessage"""
    ...
    async def handle_msg(self, message: PersbotMessage, followup_webhook=None) -> None:
        """处理消息"""
