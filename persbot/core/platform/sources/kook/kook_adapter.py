...
from persbot.api.message_components import At, AtAll, Image, Plain
...
from persbot.core.message.components import File, Record, Video
...
class KookPlatformAdapter(Platform):
    ...
    async def convert_message(self, data: KookMessageEventData) -> PersbotMessage:
        abm = PersbotMessage()
