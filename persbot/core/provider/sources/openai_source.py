...
from persbot.api.provider import Provider
from persbot.core.agent.message import ContentPart, ImageURLPart, Message, TextPart
from persbot.core.agent.tool import ToolSet
from persbot.core.message.message_event_result import MessageChain
from persbot.core.provider.entities import LLMResponse, TokenUsage, ToolCallsResult
from persbot.core.utils.io import download_image_by_url
from persbot.core.utils.network_utils import (
    create_proxy_client,
    is_connection_error,
...
class ProviderOpenAIOfficial(Provider):
    ...
    async def _parse_openai_completion(
        ...
        if choice.finish_reason == "content_filter":
            raise Exception(
                "API 返回的 completion 由于内容安全过滤被拒绝(非 Persbot)。",
            )
