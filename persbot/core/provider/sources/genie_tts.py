...
from persbot.core.provider.entities import ProviderType
from persbot.core.provider.provider import TTSProvider
from persbot.core.provider.register import register_provider_adapter
