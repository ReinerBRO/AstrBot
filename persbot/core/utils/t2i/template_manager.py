# persbot/core/utils/t2i/template_manager.py

import os
import shutil

from persbot.core.utils.persbot_path import get_persbot_data_path, get_persbot_path
...
class TemplateManager:
    ...
    CORE_TEMPLATES = ["base.html", "persbot_powershell.html"]
    ...
    def __init__(self) -> None:
        ...
        self.user_template_dir = os.path.join(get_persbot_data_path(), "t2i_templates")
