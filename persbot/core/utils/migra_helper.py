...
def _migra_provider_to_source_structure(conf: PersbotConfig) -> None:
    """
...
async def migra(
    db, persbot_config_mgr, umop_config_router, acm: PersbotConfigManager
) -> None:
    """
    ...
    try:
        await migrate_45_to_46(persbot_config_mgr, umop_config_router)
    except Exception as e:
    ...
    try:
        _migra_provider_to_source_structure(persbot_config)
    except Exception as e:
