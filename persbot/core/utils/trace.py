...
from persbot.core import LogManager, persbot_config
from persbot.core.log import LogQueueHandler
...
def _get_trace_logger():
    ...
    _trace_logger = logging.getLogger("persbot.trace")
    return _trace_logger
...
class TraceSpan:
    ...
    def record(self, action: str, **fields: Any) -> None:
        ...
        if not persbot_config.get("trace_enable", True):
            return
