"""Persbot 会话-对话管理器, 维护两个本地存储, 其中一个是 json 格式的shared_preferences, 另外一个是数据库.

在 Persbot 中, 会话和对话是独立的, 会话用于标记对话窗口, 例如群聊"123456789"可以建立一个会话,
...
from persbot.core.agent.message import AssistantMessageSegment, UserMessageSegment
from persbot.core.db import BaseDatabase
from persbot.core.db.po import Conversation, ConversationV2
from persbot.core.utils.datetime_utils import to_utc_timestamp
