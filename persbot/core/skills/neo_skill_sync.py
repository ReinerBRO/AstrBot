...
from persbot.core.computer.computer_client import sync_skills_to_active_sandboxes
from persbot.core.skills.skill_manager import SkillManager
from persbot.core.utils.persbot_path import get_persbot_skills_path
...
class NeoSkillSyncManager:
    ...
    def __init__(
        ...
        *,
        ...
        self.skills_root = skills_root or get_persbot_skills_path()
    ...
    async def sync_release(
        ...
        *,
        ...
        # Ensure local skill is visible to Persbot skill manager.
