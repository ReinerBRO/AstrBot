...
def build_skills_prompt(skills: list[SkillInfo]) -> str:
    ...
    return (
        ...
        "(one short line). Prefer `persbot_*` tools when running skill "
        "scripts.\n"
...
class SkillManager:
    def __init__(self, skills_root: str | None = None) -> None:
        ...
        data_path = Path(get_persbot_data_path())
    ...
    def install_skill_from_zip(self, zip_path: str, *, overwrite: bool = True) -> str:
        ...
        with zipfile.ZipFile(zip_path) as zf:
            ...
            with tempfile.TemporaryDirectory(dir=get_persbot_temp_path()) as tmp_dir:
