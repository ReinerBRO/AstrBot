...
from persbot.api.message_components import At, Image, Plain
from persbot.api.platform import MessageType
from persbot.api.provider import LLMResponse, Provider, ProviderRequest
...
class LongTermMemory:
    def __init__(self, acm: PersbotConfigManager, context: star.Context) -> None:
        self.acm = acm
