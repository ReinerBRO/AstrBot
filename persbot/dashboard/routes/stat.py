...
class StatRoute(Route):
    ...
    async def test_ghproxy_connection(self):
        ...
        try:
            ...
            test_url = f"{proxy_url}/https://github.com/PersbotDevs/Persbot/raw/refs/heads/master/.python-version"
    ...
    async def get_first_notice(self):
        ...
        try:
            ...
            base_path = Path(get_persbot_path())
