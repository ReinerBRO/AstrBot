...
from persbot.core.computer.computer_client import (
...
class SkillsRoute(Route):
    ...
    def _get_neo_client_config(self) -> tuple[str, str]:
        provider_settings = self.core_lifecycle.persbot_config.get(
            "provider_settings",
            {},
        )
    ...
    async def download_skill(self):
        try:
            ...
            export_dir = Path(get_persbot_temp_path()) / "skill_exports"
