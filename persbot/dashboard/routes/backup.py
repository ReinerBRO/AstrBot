...
from persbot.core.backup.importer import PersbotImporter
...
class BackupRoute(Route):
    ...
    def __init__(
        ...
        self.backup_dir = get_persbot_backups_path()
        self.data_dir = get_persbot_data_path()
        ...
        try:
            with zipfile.ZipFile(zip_path, "r") as zf:
                if "manifest.json" in zf.namelist():
                    ...
                    # 没有 manifest.json，不是有效的 Persbot 备份
                    return None
        except Exception as e:
    ...
    async def list_backups(self):
        ...
        try:
            ...
            for filename in os.listdir(self.backup_dir):
                ...
                # 如果返回 None，说明不是有效的 Persbot 备份，跳过
                ...
                backup_files.append(
                    {
                        ...
                        "persbot_version": manifest.get("persbot_version", "未知"),
