...
@click.group()
@click.version_option(__version__, prog_name="Persbot")
def cli() -> None:
    """The Persbot CLI"""
    click.echo(logo_tmpl)
    click.echo("Welcome to Persbot CLI!")
    click.echo(f"Persbot CLI version: {__version__}")
