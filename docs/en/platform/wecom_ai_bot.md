...
Persbot supports this platform since v4.3.5.
...
![Management Tools - AI Bot](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-1.png)
...
![Create AI Bot Account](https://files.persbot.app/docs/source/images/wecom_ai_bot/image.png)

## Configure Persbot

1. Open Persbot Dashboard, click `Messaging Platforms`, then click `+ Add Adapter`, choose `WeCom AI Bot`.

![Add Adapter](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-2.png)

2. Fill Persbot fields with values from the WeCom AI Bot create page:
...
- If unified mode is enabled, Persbot generates a unique callback URL after save. Copy it from logs or bot card in WebUI.
...
If you see `Service did not respond correctly`, re-check Persbot config and firewall rules.

![Bot Details](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-3.png)
...
![Add Member](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-4.png)

![Added Successfully](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-5.png)

### Chat with the Bot

Send a message in private chat or group chat to talk to the bot.

If you need typing-like streaming effect, enable `Streaming Reply` in Persbot.

![Streaming Reply](https://files.persbot.app/docs/source/images/wecom_ai_bot/image-6.png)

## Help & Support

If you have issues during setup/use or need enterprise support, contact: [community@persbot.app](mailto:community@persbot.app).
