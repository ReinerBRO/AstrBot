...
Persbot supports the native API formats of OpenAI, Google GenAI, and Anthropic. You can connect any model service provider that conforms to one of these three API formats.
...
>
> These providers support the OpenAI API format. You can find the API Base URL and API Key from their documentation and fill them into Persbot provider settings.
>
> Please note that using non-compliant third-party model services may introduce availability, privacy, or legal risks. For details, see the [EULA](https://github.com/PersbotDevs/Persbot/blob/master/EULA.md).
