...
Persbot v4.2.1 and later versions support connecting to [Coze](https://www.coze.cn/) Agent service.
...
![Create API Key](https://files.persbot.app/docs/source/images/coze/image_1.png)
...
![Create Token](https://files.persbot.app/docs/source/images/coze/image_2.png)

After that, we will get a new API Key. Please copy and save it, as it will be needed later.

![New API Key](https://files.persbot.app/docs/source/images/coze/image_3.png)
...
![Create Project](https://files.persbot.app/docs/source/images/coze/image_4.png)

![Create Project](https://files.persbot.app/docs/source/images/coze/image_5.png)
...
![Publish Agent](https://files.persbot.app/docs/source/images/coze/image_6.png)
...
![Agent Development](https://files.persbot.app/docs/source/images/coze/image_7.png)
...
## Configure Coze in Persbot

After completing all the preparation work, we can now configure Coze in Persbot.

Go to Persbot Admin Panel -> Service Provider -> Add Service Provider -> Coze to enter the configuration page.

![Coze Provider](https://files.persbot.app/docs/source/images/coze/image_8.png)
