...
>[!TIP]
>Please ensure that the APP type you set in Persbot matches the application type created in Dify.
>![image](https://files.persbot.app/docs/source/images/dify/image-3.png)
...
![image](https://files.persbot.app/docs/source/images/dify/chat-agent-api-key.png)

![image](https://files.persbot.app/docs/source/images/dify/chat-agent-api-key-2.png)
...
![image](https://files.persbot.app/docs/source/images/dify/workflow-io-key.png)

For Workflow applications, Persbot will attach two variables with each request:

- `persbot_text_query`: Input variable name. This is the text content entered by the user.
- `persbot_session_id`: Session ID
...
You need to modify the input variable name of your Workflow to adapt to Persbot's input.

Finally, the Workflow will output a result. You can customize the variable name of this result, which is the "Dify Workflow Output Variable Name" in the configuration above, with a default value of `persbot_wf_output`. You need to configure this variable name in the output node of the Dify Workflow, otherwise Persbot cannot parse it correctly.
...
![image](https://files.persbot.app/docs/source/images/dify/workflow-api-key.png)
...
![alt text](https://files.persbot.app/docs/source/images/dify/image-5.png)

After setting variables, Persbot will attach the variables you set in the next request to Dify, flexibly adapting to your Workflow.

![alt text](https://files.persbot.app/docs/source/images/dify/image-4.png)
