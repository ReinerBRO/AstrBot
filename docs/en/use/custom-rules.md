...
Since version v4.7.0, we have refactored Persbot's original "Session Management" feature into the "Custom Rules" feature to reduce conflicts with configuration files.
