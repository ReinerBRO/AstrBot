...
# Persbot Knowledge Base

> [!TIP]
> Requires Persbot version >= 4.5.0.

![Knowledge Base Preview](https://files.persbot.app/docs/en/use/image-3.png)

## Configuring Embedding Model

Open the service provider page, click "Add Service Provider", and select Embedding.

Currently, Persbot supports embedding vector services compatible with OpenAI API and Gemini API.
...
Persbot supports multiple knowledge base management. During chat, you can **freely specify which knowledge base to use**.
...
![Upload Files](https://files.persbot.app/docs/en/use/image-4.png)
...
5. Fill in the Persbot OpenAI Embedding model provider configuration:
