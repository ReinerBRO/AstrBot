...
MANIFEST_NAME = ".persbot-wiki-sync-manifest"
SOURCE_ALIASES = {
...
LANG_CONFIG = {
    "zh": {
        "index_title": "# Persbot 中文文档",
        "index_intro": "该页面由 `Persbot-docs` 自动同步到 GitHub Wiki。",
        "index_links": [
            ("关于 Persbot", "zh-what-is-persbot"),
            ("社区", "zh-community"),
            ("常见问题", "zh-faq"),
        ],
        "home_intro": "该 Wiki 由 `Persbot-docs` 自动同步生成。",
        "home_links": [
            ("中文文档入口", "zh-index"),
    ...
    "en": {
        "index_title": "# Persbot English Documentation",
        "index_intro": "This page is synchronized automatically from `Persbot-docs` to the GitHub wiki.",
        "index_links": [
            ("What is Persbot", "en-what-is-persbot"),
            ("Community", "en-community"),
            ("FAQ", "en-faq"),
        ],
        "home_intro": "This wiki is synchronized automatically from `Persbot-docs`.",
        "home_links": [
...
def build_home_page(language: str) -> str:
    config = LANG_CONFIG[language]
    lines = ["# Persbot Wiki", "", config["home_intro"], ""]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Sync Persbot docs content to GitHub wiki pages."
    )
    parser.add_argument(
        "--source-root",
        default=str(repo_root()),
        help="Path to the Persbot-docs repository root.",
    )
    parser.add_argument(
        "--wiki-root",
