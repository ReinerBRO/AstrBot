...
欢迎来到 Persbot 插件开发指南！本章节将引导您如何开发 Persbot 插件。在我们开始之前，希望你能具备以下基础知识：
...
> [!WARNING]
> 请务必修改此文件，Persbot 识别插件元数据依赖于 `metadata.yaml` 文件。
...
您可以使用 Persbot 的热重载功能简化开发流程。

插件的代码修改后，可以在 Persbot WebUI 的插件管理处找到自己的插件，点击右上角 `...` 按钮，选择 `重载插件`。
