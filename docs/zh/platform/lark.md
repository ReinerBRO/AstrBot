...
![创建企业自建应用](https://files.persbot.app/docs/source/images/lark/image.png)

添加应用能力——机器人。

![添加应用能力](https://files.persbot.app/docs/source/images/lark/image-1.png)

点击凭证与基础信息，获取 app_id 和 app_secret。

![获取 app_id 和 app_secret](https://files.persbot.app/docs/source/images/lark/image-4.png)
...
如果您选择了 `webhook` 方式，选择了之后，前往飞书的开发者后台，点击事件与回调，点击加密策略，填写 Encrypt Key。这不是必须的，Persbot 十分注重你的数据安全，所以请务必填写。填写后复制 `Encrypt Key` 和 `Verification Token` 到 Persbot 配置的 `encrypt_key` 和 `verification_token` 处。
...
![设置事件与回调](https://files.persbot.app/docs/source/images/lark/image-6.png)
...
![添加事件](https://files.persbot.app/docs/source/images/lark/image-7.png)

点击开通以下权限。

![开通权限](https://files.persbot.app/docs/source/images/lark/image-8.png)
...
![最终开通的权限](https://files.persbot.app/docs/source/images/lark/image-11.png)

## 创建版本

创建版本。

![创建版本](https://files.persbot.app/docs/source/images/lark/image-2.png)
...
搜索刚刚创建的机器人的名字。比如教程创建了 `Persbot` 机器人：

![添加机器人](https://files.persbot.app/docs/source/images/lark/image-9.png)

## 🎉 大功告成

在群内发送一个 `/help` 指令，机器人将做出响应。

![成功](https://files.persbot.app/docs/source/images/lark/image-13.png)